...
export const BUILTIN_CLAUSE_BLOCKS: ContractClauseBlock[] = [
  ...
  },
  {
    ...
    template_kinds: PROJECT,
    condition: "always",
    title: "예약금 환불 불가 및 중도 해지 작업비",
    body: "① (예약금 환불 불가) 예약금은 착수금의 성격을 가지며, 계약 체결 및 결제 완료 후 을의 단순 변심, 결과물 취향 불일치, 본결제 미진행, 계약 취소 등의 사유가 발생하더라도 환불되지 않는다. ② (중도 해지 작업비) 초안 또는 결과물이 제공된 이후 수정 요청까지 진행된 상태에서, 을이 결과물이 마음에 들지 않는다는 이유로 계약을 중단하는 경우 갑은 총 계약금액의 추가 30%를 작업비로 청구할 수 있다. ③ (작업 진행 비용 인정) 이 경우 갑은 총 계약금액 중 예약금 30%와 작업비 30%, 합계 60%를 작업 진행 비용으로 인정받으며, 잔여 40%에 대해서는 청구하지 않는다. ④ (회사 귀책 예외) 다만 갑의 귀책으로 산출물이 전혀 제공되지 않은 경우에는 환불·정산을 별도 협의한다.",
    sort_order: 120,
    active: true,
  },
  {
