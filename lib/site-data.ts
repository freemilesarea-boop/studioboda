...
export const footerLinks = [
  {
    title: "서비스",
    items: [
      { label: "상세페이지", href: "/services/detail" },
      { label: "SNS 콘텐츠", href: "/services/sns" },
      { label: "광고 배너", href: "/services/ad" },
      { label: "썸네일", href: "/services/thumb" },
      { label: "브랜드 디자인", href: "/services/brand" },
