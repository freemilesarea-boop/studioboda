...
const NAV = [
  ...
  { href: "/me/contracts", label: "계약서", icon: "ti-file-text", match: /^\/me\/contracts/ },
  ...
  { href: "/me/reviews", label: "후기", icon: "ti-star", match: /^\/me\/reviews/ },
...
export function MeMobileNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-30 grid border-t border-ink-15 bg-white lg:hidden"
